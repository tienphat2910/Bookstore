$(document).ready(function () {
    ...
    // Sự kiện nhấp vào "Thay đổi địa chỉ khách hàng" trong menu bên trái
    $("#changeAddressLink").on("click", function () {
        // Chuyển sang tab "Sổ địa chỉ" khi nhấp vào
        $("#addressLink").click(); // Tự động click vào tab "Sổ địa chỉ"
    });
