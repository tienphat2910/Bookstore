...
document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdownButton.addEventListener('click', function (event) {
        event.stopPropagation(); // Ngăn chặn sự kiện click truyền lên trên
        const isOpen = dropdownMenu.classList.contains('show'); // Kiểm tra menu đang mở hay không
