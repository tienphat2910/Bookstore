...
$(document).ready(function () {
    ...
    const dropdownMenu = $("#userDropdownMenu"); // Cập nhật id để phù hợp với mã HTML mới

    if (isLoggedIn === "true") {
        // Nếu đã đăng nhập, hiển thị Chi tiết tài khoản và Đăng xuất
        dropdownMenu.html(`
        ...
        $("#logout").on("click", function () {
            // Xóa trạng thái đăng nhập và tải lại trang để cập nhật giao diện
